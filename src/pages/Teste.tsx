      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          {selectedGameForSignal ? <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-5xl mx-auto">
                {games.map((game, index) => <Card key={game.id} className={`bg-card border-border cursor-pointer hover:scale-105 transition-all duration-300 text-center p-4 min-w-fit`} onClick={() => setSelectedGameForSignal(game)}>
        ...
        <Card className="bg-card border-gold/20 overflow-hidden">
          <div className="p-4 bg-gradient-gold text-black">
            <h3 className="text-xl font-display font-bold text-center">🎮 AVIATOR</h3>
            
          </div>
          
          <div className="relative">
            <iframe src="https://aviator-demo.spribegaming.com/?currency=BRL&operator=demo&jurisdiction=CW&lang=PT&user=10961&token=IJgSzSBFoNBnES1tSY8KhWlbxku003Oh" width="100%" height="700" className="border-none" title="Aviator Demo Game" allowFullScreen />
            
            {/* CSS para esconder fun mode */}
            <style>{`
              iframe[title="Aviator Demo Game"] {
                filter: none !important;
              }
              /* Tentativa de esconder elementos fun mode via CSS */
              [class*="fun"], [class*="demo"], [id*="fun"], [id*="demo"] {
          ...
          <div className="p-4 bg-black/50 text-center">
            <p className="text-gold font-medium">
              🎯 Teste seus sinais | ⚡ Resultados em tempo real | 🔒 Ambiente seguro
            </p>
          </div>
        </Card>
      </section>
